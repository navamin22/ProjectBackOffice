...
class DialogSold : DialogFragment(){
    private lateinit var myContext: Context
    lateinit var binding: DialogSoldBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,
            R.layout.dialog_sold,container,false)
        initInstance()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.takeIf {
            ...
            binding.serialnumber10.text = model
            binding.serialnumber0.text = serialnumber
            binding.name0.text = borrowName
            binding.appCompatTextView0.text = date_borrow
            binding.objective0.text = date_return
            binding.objective10.text = objective
